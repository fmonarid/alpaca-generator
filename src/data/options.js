export const ALPACA_CATEGORIES = [
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'bend-backward', label: 'Bend Backward', filename: 'bend-backward.png' },
            { id: 'bend-forward', label: 'Bend Forward', filename: 'bend-forward.png' },
    ...
    },
    {
        ...
        options: [
            { id: 'default', label: 'Default', filename: 'default.png' },
            { id: 'tilt-backward', label: 'Tilt Backward', filename: 'tilt-backward.png' },
            { id: 'tilt-forward', label: 'Tilt Forward', filename: 'tilt-forward.png' },
        ],
    },
    {
        id: 'eyes',
    ...
    },
    {
        ...
        options: [
            ...
            { id: 'game-console', label: 'Game Console', filename: 'game-console.png' },
            { id: 'tilt-backward', label: 'Tilt Backward', filename: 'tilt-backward.png' },
            { id: 'tilt-forward', label: 'Tilt Forward', filename: 'tilt-forward.png' },
        ],
    },
